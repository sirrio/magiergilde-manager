...
<template>
  <dialog ref="modalCreateItem" class="modal">
    <div class="modal-box">
      <form method="dialog">
        <button class="btn btn-sm btn-circle btn-ghost absolute top-2 right-2">✕</button>
      </form>
      <h3 class="mb-6 text-lg font-bold">Create Item</h3>
      ...
      <button class="btn btn-neutral mt-6" @click="clickCreateItem()">Create</button>
    </div>
  </dialog>
</template>
