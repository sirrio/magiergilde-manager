  ...
  <AuthenticatedLayout>
    <div class="px-6 py-6">
      <div class="mx-auto flex max-w-7xl flex-col gap-3">
        <label class="label">
          <span class="label-text mr-3 font-bold tracking-wide uppercase">Seed:</span>
          <input v-model="seed" class="input input-xs" type="text" />
        </label>
        <UniqueItemsTable
          ...
          :items="
            shuffleArray(
              items.filter((i) => i.rarity === 'common' && i.type === 'item'),
              seed,
            ).splice(0, 5)
          "
        />
        <UniqueItemsTable
          ...
          :items="
            shuffleArray(
              items.filter((i) => i.rarity === 'common' && i.type === 'consumable'),
              seed,
            ).splice(0, 1)
          "
        />
        <UniqueItemsTable
          ...
          :items="
            shuffleArray(
              items.filter((i) => i.rarity === 'common' && i.type === 'spellscroll'),
              seed,
            ).splice(0, 1)
          "
        />
        <UniqueItemsTable
          ...
          :items="
            shuffleArray(
              items.filter((i) => i.rarity === 'uncommon' && i.type === 'item'),
              seed,
            ).splice(0, 3)
          "
        />
        <UniqueItemsTable
          ...
          :items="
            shuffleArray(
              items.filter((i) => i.rarity === 'uncommon' && i.type === 'consumable'),
              seed,
            ).splice(0, 1)
          "
        />
        <UniqueItemsTable
          ...
          :items="
            shuffleArray(
              items.filter((i) => i.rarity === 'uncommon' && i.type === 'spellscroll'),
              seed,
            ).splice(0, 1)
          "
        />
        <UniqueItemsTable
          ...
          :items="
            shuffleArray(
              items.filter((i) => i.rarity === 'rare' && i.type === 'item'),
              seed,
            ).splice(0, 2)
          "
        />
        <UniqueItemsTable
          ...
          :items="
            shuffleArray(
              items.filter((i) => i.rarity === 'rare' && (i.type === 'consumable' || i.type == 'spellscroll')),
              seed,
            ).splice(0, 1)
          "
        />
        <UniqueItemsTable
          ...
          :items="
            shuffleArray(
              items.filter((i) => i.rarity === 'very_rare' && i.type === 'item'),
              seed,
            ).splice(0, 1)
          "
        />
        <UniqueItemsTable
          ...
          :items="
            shuffleArray(
              items.filter((i) => i.rarity === 'very_rare' && (i.type === 'consumable' || i.type == 'spellscroll')),
              seed,
            ).splice(0, 1)
          "
        />
